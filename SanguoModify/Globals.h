...
unsigned int nFirstKingDataOffset = 0x000001D0;
unsigned int nKingDataSize=0x00000352;
...
#ifndef WUJIANGJI_TABLE
#define WUJIANGJI_TABLE

CString SGQY2_WUJIANGJI[0xFF] =		//此列表为武将名中所有中文的BIG编码对应GB2312汉字
{
...
#ifndef JUNSHIJI_TABLE
#define JUNSHIJI_TABLE

CString SGQY2_JUNSHIJI[0xFF] =		//此列表为武将名中所有中文的BIG编码对应GB2312汉字
{
